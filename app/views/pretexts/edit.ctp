...
<?php echo $this->Form->create('Pretext');?>
	<fieldset>
		<legend><?php __('Edit Pretext'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Pretext.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Pretext.id'))); ?></li>
